...
# def generate_fast_cache_key(entity_uuid: str, status_filter: str, name: Optional[str], limit: int, skip: int) -> str:
...
# async def get_buildings_optimized(entity_uuid: str, status_filter: Optional[str], name: Optional[str], limit: int, skip: int, db: AsyncSession) -> List[Dict]:
...
#     cache_key = generate_fast_cache_key(entity_uuid, status_filter or "active", name, limit, skip)
